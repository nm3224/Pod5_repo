...
print()
print(f"The possible prices for the 116-inch Macbook Pro are: {laptops[0]['types'][1]['price']}")

# TODO: Write code to print all the color options for Dell XPS 13.
print()
print(f"The color options for the Dell Xps 13-inch latptop are: {laptops[1]['types'][0]['colors']}")

# TODO: Write code to print the description of Dell XPS laptop.
print()
print(f" The description of the Dell XPS laptop is:\n\n{laptops[1]['description']}")
