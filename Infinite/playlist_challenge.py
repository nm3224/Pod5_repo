...
'''
song_one = {'artist': 'Lauryn Hill', 'title': 'That thing'}
...
print('Question 5')
song_two = {'artist': 'Young Dolph', 'title': 'One Scale'}

song_three = {'artist': 'Griselda', 'title': 'DR Birds'}
...
avgerage_monthly_plays = round(np.mean(monthly_plays))
print(avgerage_monthly_plays)
...
print('BONUS')
#Not yet familiar with the concept associated
