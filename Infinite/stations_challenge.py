...
class SubwayStation(Station):
    ...
    def show_info(self):
       print(f'{self.station_name} station is located at {self.location} and {self.lines} pass through this station.')
...
Fourteenth_street = SubwayStation(station_name, location, lines)
Fourteenth_street.show_info
