...
my_library.add(title='My GrandmotherS hand',author= 'Bryan Stevenson')
...
nyt_bestsellers.add(title='The Wish', author='Nicholas Sparks')
nyt_bestsellers.add(title='The Man Who Died Twice', author='Richard Osman')

for book in nyt_bestsellers.book:
    print(book.title, book.author)
...
for book in my_library.books:
     nyt_bestsellers.add(book.title, book.author)
