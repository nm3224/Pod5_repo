...
# remove the 1tb storage option for the 16-inch MacBook Pro
laptops[0]["types"][1]["storage"].remove("1 TB SSD")
# remove the space gray color for the 13-inch MacBook Pro
