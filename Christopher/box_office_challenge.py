...
# Check that The Matrix is in "remaining_50_list"
print(remaining_50_list.index("The Matrix"))
# Remove The Matrix from "remaining_50_list"
...
print(len(remaining_50_list)) # 49
...
print(len(remaining_50_list)) # 50
...
print(top_100[0:10])    # start and stop indices
# Alternately, don't use the 0:10 syntax, just use :10
print(top_100[:10]) # start index is 0, don't need to specify it
...
print(f'Here are the top {len(top_100)} movies: {top_100_str}')
