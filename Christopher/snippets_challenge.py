...
if u * v == 10: # double equals for comparison, single for assignment
...
a = 1
b = 1
c = (a == b) # this comparison produces a Boolean value and assigns it to c
...
d = (5 > 7) or not (8 < 20) # without changing the assert statement produces an error
