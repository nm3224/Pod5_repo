...
def search_by_name(book):
    # Check if book is in books list
    if book in books:
        # print 'Available' if book is in books list
        print('Available')
    else:
        # print 'Not Available' if book is not in books list
        print('Not Available')
...
# books_with_details is a list of items, each item is a dictionary. Each dictionar has a key 'title' and a key 'author' that are strings.
