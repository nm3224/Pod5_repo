...
print('The type of error thrown is: "ValueError"')
...
def print_tenth_item(top_ten):
    if len(top_ten) < 10:
        num_more_needed = 10 - len(top_ten)
        print(f"Your list is not the correct length. It needs to be at least 10 items. You're list needs {num_more_needed} more items.")
