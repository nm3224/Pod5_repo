...
'''
# define a function called play_track()
#It should have two parameters
#'playlist' (a list)
#track' (an integer) - this should be optional, and by default play track 1

# play_track() will take two arguments, 'playlist' and 'track'
 # track is optional, and by default will be 1
 # to define a default value for track, use the '=' sign

def play_track(playlist, track = 1):
     # print the song that is being played
     print(f'Playing Track {track}, {playlist[track-1]["title"]} performed by {playlist[track-1]["artist"]}')
     # increment the plays for the song up by 1
