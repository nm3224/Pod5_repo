print("Music playlist challenge!")

# import playlist_functions and numpy as np *
import numpy as np
...
'''
#create dictionary named song_one and add to my_playlist using add_song in functions.py
song_one = {'artist': 'ALTJ', 'title':'Breezeblocks'}
add_song(my_playlist, song_one)
...
song_two = {'artist': 'U2', 'title':'One'}
song_three = {'artist': 'Francis Scott Key', 'title':'Star Spangled Banner'}
...
plays_average = np.mean(monthly_plays)
print(f'The monthly play average is {plays_average}')
...
print('Playlist after playing selected tracks:')
display_playlist(my_playlist) 