...
print()
print('Question Bonus:')# Bonus: Run available_books function again to see if the book was checked out
available_books()
print()
...
def search_by_name(book):
    if book in books:
        print(f'{book} is Available for check-out.')
    else:
        print (f'{book} is Not Available for check-out.')
...
print('We know this is a LIST OF DIFFERENT DICTIONARIES, [] SQUARE BRACKET INDICATES LIST, {} CURLY BRACKET INDICATES DICTIONARY')
