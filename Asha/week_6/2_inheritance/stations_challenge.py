...
class Station:
    ...
    def show_info(self):
        print(f'The {self.station_name} station is located at {self.location}.')

class SubwayStation(Station):
    def __init__(self,station_name, location, lines):
        super().__init__(station_name, location) #inherit from Station Parent
        self.lines = lines
        
    def show_info(self):
        print(f"The {self.station_name} station is located at {self.location}. It's lines are {self.lines} and stops at {self.station_name}.")
...
lines: ['1', '2', '3', 'L']
'''
subway_station1 = SubwayStation(station_name = "14th street", location = "14th Street and 7th Avenue", lines = ["1", "2", "3", "4"]) 
...
class BusStation(Station):
    ...
    def show_info(self):
        if self.open:
            print(f"The {self.station_name} station located at {self.location} which stops at {self.routes} is open.")
        else:
            print(f"The {self.station_name} station located at {self.location} which stops at {self.routes} is closed.")
...
bustation1 = BusStation(station_name = 'NYC Megabus Stop',location = '34th street and 12th avenue',routes = ['Boston', 'DC', 'Philly'])
print()
bustation1.show_info()
print()
bustation1.close_station()
print()
bustation1.show_info()
print()
bustation1.open_station()
print()
bustation1.show_info()
