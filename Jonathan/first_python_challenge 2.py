...
meal = 'I want pepporoni pizza for dinner.'
print(meal)
...
current_year = 2022
google_founded_year =  1993
google_age = current_year - google_founded_year
...
print('The variable was missing an underscore between the words completion and message, and there was a quote missing after the last character.')
