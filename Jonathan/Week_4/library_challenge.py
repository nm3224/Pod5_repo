...
print ('We know this is a list of dictionaries, because the books_with_details has a group within square brackets.  And within the brackets there are groups within curly brackets, which denotes dictionaries.')
print()
# 2.1
