...
'''
song_one = {'artist': 'LCD Soundsystem', 'title': 'Daft Punk is Playing at My House'}
...
song_two = {'artist': 'Cut Copy', 'title': 'Saturdays'}
add_song(my_playlist, song_two)

song_three = {'artist': 'alt-J', 'title': 'Fitzpleasure'}
