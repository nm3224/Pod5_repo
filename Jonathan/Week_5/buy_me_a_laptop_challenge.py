...
print()
print(f"The URL for Apple Macbook is {laptops[0]['url']}.")

# TODO: Write code to print all possible prices of the 16-inch MacBook Pro.
print()
print(f'The possible prices for the 16-inch MacBook Pro are {laptops[0]["types"][1]["price"]}.')

# TODO: Write code to print all the color options for Dell XPS 13.
print()
print(f'The possible color options for the Dell XPS 13 are {laptops[1]["types"][0]["colors"]}.')
...
for price in laptops:
    price = (laptops[0]["types"][0]["price"]), (laptops[0]["types"][1]["price"]), (laptops[1]["types"][0]["price"]), (laptops[1]["types"][1]["price"])
print(price)
