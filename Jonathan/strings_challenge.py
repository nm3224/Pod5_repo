...
print(f'I will need {ingredient_1}, {ingredient_2}, {ingredient_3}, and {ingredient_4}.')


# 2. String Methods
# 2.1 Save your f-string from step 1.3 as a variable called ingredients
ingredients = f'I will need {ingredient_1}, {ingredient_2}, {ingredient_3}, and {ingredient_4}.'
print(ingredients) 
...
activity = input ("What is your favorite things to do for fun? ")
