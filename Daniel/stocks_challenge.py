...
if stock == "amzn":
    ...
    print("This is not one of the selections.")
...
print(f"{user_name} has {user_savings} in savings and they can buy {num_stocks} shares of {stock} at the current price of the stock.")
