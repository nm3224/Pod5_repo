...
print("This is a list of dictionaries. We know because it is a list of elements separated by commas in brackets. We know the elements are dictionaries because they are keys and values in curly braces.")
# 2.1
...
# function top line
# for a book in the list books with details
# instruct python to go through each element of list. 
# instruct python to examine each dictionary and its key
# instruct python that if the key matches the search, to add that value in the list author list
# instruct python to save that value (redundant?)
# instruct python to print the values.
