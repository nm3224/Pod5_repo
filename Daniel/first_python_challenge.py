...
print(f"There was a syntax error with completion_message variable. A space was eliminated and an underscore added. It also required an end quote to have python recognize it was a string.")
