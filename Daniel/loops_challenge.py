...
for day in days:
    activity = input(f"What do is your favorite thing to do on {day}")
...
for index in range(len(days)):
    print(f"On {days[index]}, your favorite activity is to {activities[index]}.")
...
new_temp = int(input(f"What is the temperature outside?"))
