...
# Reformat movies_str so each movie is separated by ', ' for consistency for the purpose of the exercise
movies_list = movies_str.split(',')
reformatted_movies_list = [movie.strip() for movie in movies_list]
movies_str = ", ".join(reformatted_movies_list)
# print(movies_str)
...
# remaining_50_list.extend(["Anywhere But Here"])
print(remaining_50_list)
