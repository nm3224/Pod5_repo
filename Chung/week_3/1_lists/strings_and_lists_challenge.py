...
# 1.2 TODO: We want to separate the first name and last name of lower_name and save it in a variable 'names_list' (use a string method to split the string into a list)
