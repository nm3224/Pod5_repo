...
meal = "Kung Pow Chiecken with rice"
print(meal)
...
print('There were two errors: One is in the name of the variable "completion\nmessage", and space in a variable name is prohibited. The other error was in\nthe string assigned to the variable as the string did not have an end quote.')
