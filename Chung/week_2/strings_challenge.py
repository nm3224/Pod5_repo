...
print('The four ingridients are: ', 'milk', 'eggs', 'flour', 'sugar')
...
print('The four ingredients are ' + ingredient_1 + ', ' + ingredient_2 + ', ' + ingredient_3 + ' and ' + ingredient_4 + '.')
...
print(f'The four ingredients are {ingredient_1}, {ingredient_2}, {ingredient_3} and {ingredient_4}.')

# 1.4 Use .join() method
print(f'The four ingredients are: {" ".join([ingredient_1, ingredient_2, ingredient_3, ingredient_4])}')

# 1.5 Use %
print(f'The four ingredients are: {"% s % s % s % s" % (ingredient_1, ingredient_2, ingredient_3, ingredient_4)}')

# 1.6 User .format() method
print('The four ingredients are: {} {} {} {}'.format(ingredient_1, ingredient_2, ingredient_3, ingredient_4))

# 2. String Methods
# 2.1 Save your f-string from step 1.3 as a variable called ingredients
ingredients = f'The four ingredients are {ingredient_1}, {ingredient_2}, {ingredient_3} and {ingredient_4}.'
...
print(type(frequency))  # <class 'str'>
