...
# print(f'The data type of the "books" object is {type(books)}.')
...
# Answer: books_with_details is a list of values that are of dictionary type
...
def search_by_author(author):
    ...
    for book in books_with_details:
        if book['author'] == author:
            book_titles_by_author.append(book['title'])
    return book_titles_by_author
